        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="p-4 border border-dark">
                    ...
                    <input name="id" style="display: none;" type="text" value="<?php echo $_GET['edit'];?>">
                    <div class="mb-3">
                    ...
                    <div class="mb-3 py-2">
                        <input name="sliderEditPostBtn" type="submit" class="btn btn-info text-light text-right" value="Add Product">
                    </div>
                </div>
            </div>
