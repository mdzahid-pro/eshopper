			...
			<div class="row">
					...
					<div class="left-sidebar">
						...
						<div class="price-range"><!--price-range-->
							...
							<div class="well text-center">
								 <input type="text" class="span2" value="" data-slider-min="<?php echo $product->maxPrice()['min'];?>" data-slider-max="<?php echo $product->maxPrice()['max'];?>" data-slider-step="5" data-slider-value="[<?php echo $product->maxPrice()['min'];?>,<?php echo ceil($product->maxPrice()['max'] /1.1);?>]" id="sl2" ><br />
								 <b class="pull-left">&#2547; <?php echo $product->maxPrice()['min'];?></b> <b class="pull-right">&#2547; <?php echo $product->maxPrice()['max'];?></b>
							</div>
						</div><!--/price-range-->
						
						<div class="shipping text-center"><!--shipping-->
							<img src="<?php echo ep_option($con,'siteurl');?>/ep-content/asset/images/home/shipping.jpg" alt="" />
						</div><!--/shipping-->
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<?php
							echo '<div id="checkAjax"></div>';
						?>
					</div>
					<div id="all_product" class="features_items"><!--features_items-->

						
						<h2 class="title text-center">Features Items</h2>
						<?php
							foreach($product->all_product(length: 9) as $prd){ ?>
								<div class="col-sm-4">
